      ...
      {(popupState) => (
        <div>
          <Typography className='textFont' {...bindHover(popupState)}>
            <button className='md:text-lg text-2xl hover:text-[#E1C300] font-extrabold'>{title}</button>
          </Typography>
            ...
            <div className='flex h-[300px] w-screen max-w-full cursor-pointer items-center justify-between gap-2 overflow-hidden bg-[#212122] px-4 py-8 hover:text-[#E1C300] text-white'>
              <div className='flex w-1/2 flex-col justify-start gap-1 py-4'>
                <div className='my-2 flex'>
                  <button className='textFont mr-auto cursor-pointer border-none bg-transparent px-4 text-lg font-bold hover:text-[#E1C300] text-white'>
                    apparel
                  </button>
                </div>
                <div className='flex flex-col'>
                  <button className='textFont mr-auto cursor-pointer border-none bg-transparent px-4 text-lg hover:text-[#E1C300] text-white'>
                    unisex hoodies
                  </button>
                  <button className='textFont mr-auto cursor-pointer border-none bg-transparent px-4 text-lg hover:text-[#E1C300] text-white'>
                    unisex zip hoodies
